            ...
            <div
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-6 xl:w-3/12" v-for="i in 1"
                            :key="i">
                            <div
                                ...
                                <div class="relative">
                                    <a class="block shadow-xl rounded-2xl">
                                        <img loading="lazy"
                                            src="https://images.unsplash.com/photo-1693751705443-231fcf26469c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw1M3x8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                                            alt="img-blur-shadow" class="w-full shadow-soft-2xl h-60 rounded-2xl" />
                                    </a>
                                </div>
                                <div class="flex-auto px-1 pt-3">
                                    <p
                                        ...
                                        Security </p>
                                    <a href="">
                                        <h1>iPhone 15’s shift to USB-C has hidden potential to streamline computing</h1>
                                    </a>
                                    <p class="mb-6 leading-normal text-sm">Hotel and casino giant MGM Resorts has confirmed
                                        a “cybersecurity issue” is to blame for an ongoing outage affecting systems at the
                                        company’s Las Vegas properties. “MGM Resorts recently ident...</p>
                                    <div class="flex items-center justify-between">
                                        <router-link :to="'/feed/JohnDoe'">
                                            <button type="button"
